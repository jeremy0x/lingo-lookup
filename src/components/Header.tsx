...
const Header = () => {
  return (
    <header className='mt-16 mb-10 flex flex-col place-items-center gap-8 text-center'>
      <h1 className='animate__animated animate__bounceInDown max-w-full overflow-hidden truncate whitespace-nowrap px-4 text-5xl font-semibold sm:overflow-visible sm:text-6xl'>
        LingoLookup
      </h1>
